 ...
 *
 * Updated:    11/16/20 - Purpose moved to FT_Cache modified to build without 
 *             warning under C++
 * 
 ...
 *
 * This file is part of the ftc project.
 ****************************************************************************/

#ifndef _FT_Cache_LOGGING_H_
#define _FT_Cache_LOGGING_H_
...
#ifdef FT_Cache_CLIENT
#define L4C_CAT_NAME "FT_Cache_CLIENT"
...
#define L4C_LOG_NAME_PREFIX (char *)"ftc_intercept_log"
#elif defined FT_Cache_SERVER
#define L4C_CAT_NAME "ftc_server"

// /tmp is a lousy location for these log files and probably only useful
// for the ftc developers.  That said, it's the best I can think of
// right now.  It's going to be imperative that users set an environment
// variable for the log file location.
#define L4C_LOG_DIR "."
#define L4C_LOG_NAME_PREFIX "ftc_server_log"
#else
// In case we somehow forgot to define the correct macro
#error Neither FT_Cache_CLIENT nor FT_Cache_SERVER was defined! Check your build scripts!
#define L4C_CAT_NAME "ftc_UNKNOWN"
...
#define FT_Cache_LOG_LEVEL "FT_Cache_LOG_LEVEL"

// Name of an environment variable the user can define to set the location
// of the log files.
#define FT_Cache_LOG_DIR "FT_Cache_LOG_DIR"
...
#define FT_Cache_LOG_PREFIX "FT_Cache_LOG_PREFIX"
